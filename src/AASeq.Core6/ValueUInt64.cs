...
/// UInt64 value.
/// </summary>
public sealed class ValueUInt64 : Value {
    ...
    public static ValueUInt64 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueUInt64? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueUInt64(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator ulong(ValueUInt64 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueUInt64 obj)
        => obj.ToString();
