...
/// Float64 value.
/// </summary>
public sealed class ValueFloat64 : Value {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public ValueFloat64(Double value) {
        _value = value;
    }
    ...
    public static ValueFloat64 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueFloat64? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueFloat64(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator double(ValueFloat64 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueFloat64 obj)
        => obj.ToString();
