...
/// Date value.
/// </summary>
public sealed class ValueDuration : Value {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public ValueDuration(TimeSpan value) {
        _value = value;
    }
    ...
    public static ValueDuration Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueDuration? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueDuration(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    internal static bool TryParseValue(string? text, out TimeSpan result) {
        if (TimeSpan.TryParseExact(text, ValueDateTime.ParseTimeSpanFormats, CultureInfo.InvariantCulture, TimeSpanStyles.None, out result)) {
            return true;
    ...
    public static implicit operator TimeSpan(ValueDuration obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueDuration obj)
        => obj.ToString();
