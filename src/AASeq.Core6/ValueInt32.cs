...
/// Int32 value.
/// </summary>
public sealed class ValueInt32 : Value {
    ...
    public static ValueInt32 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueInt32? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueInt32(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator int(ValueInt32 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueInt32 obj)
        => obj.ToString();
