...
/// UInt64 value.
/// </summary>
public sealed class ValueSize : Value {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public ValueSize(UInt64 value) {
        _value = value;
    }
    ...
    public static ValueSize Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueSize? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueSize(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator ulong(ValueSize obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueSize obj)
        => obj.ToString();
