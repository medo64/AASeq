...
/// IPAddress value.
/// </summary>
public sealed class ValueIPAddress : Value {
    ...
    public ValueIPAddress(IPAddress value) {
    ...
    public static ValueIPAddress Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueIPAddress? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueIPAddress(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator IPAddress(ValueIPAddress obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueIPAddress obj)
        => obj.ToString();
