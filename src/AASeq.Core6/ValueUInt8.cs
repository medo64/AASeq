...
/// UInt8 value.
/// </summary>
public sealed class ValueUInt8 : Value {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public ValueUInt8(Byte value) {
        _value = value;
    }
    ...
    public static ValueUInt8 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueUInt8? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueUInt8(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator byte(ValueUInt8 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueUInt8 obj)
        => obj.ToString();
