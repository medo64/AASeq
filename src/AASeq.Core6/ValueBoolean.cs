...
public sealed class ValueBoolean : Value {
    ...
    public static ValueBoolean Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueBoolean? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueBoolean(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator bool(ValueBoolean obj)
       => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueBoolean obj)
        => obj.ToString();
