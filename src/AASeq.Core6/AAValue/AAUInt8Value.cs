...
/// UInt8 value.
/// </summary>
public sealed class AAUInt8Value : AAValue {
    ...
    public static AAUInt8Value Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out AAUInt8Value? result) {
        if (TryParseValue(text, out var value)) {
            result = new AAUInt8Value(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    /// <param name="text">Text to parse.</param>
    /// <param name="result">Conversion result.</param>
    internal static bool TryParseValue(string? text, out Byte result) {
    ...
    public override bool Equals(object? obj) {
        if (obj is AAUInt8Value otherValue) {
            return Value.Equals(otherValue.Value);
        } else if (obj is Byte objValue) {
    ...
    /// <summary>
    /// Implicit conversion into a byte.
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator byte(AAUInt8Value obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(AAUInt8Value obj)
        => obj.ToString();
