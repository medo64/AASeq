...
/// UInt16 value.
/// </summary>
public sealed class AAUInt16Value : AAValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public AAUInt16Value(UInt16 value) {
        Value = value;
    }
    ...
    public static AAUInt16Value Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out AAUInt16Value? result) {
        if (TryParseValue(text, out var value)) {
            result = new AAUInt16Value(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public override bool Equals(object? obj) {
        if (obj is AAUInt16Value otherValue) {
    ...
    public static implicit operator ushort(AAUInt16Value obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(AAUInt16Value obj)
        => obj.ToString();
