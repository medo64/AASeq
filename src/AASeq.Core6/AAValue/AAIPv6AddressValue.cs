...
/// IPv6Address value.
/// </summary>
public sealed class AAIPv6AddressValue : AAValue {
    ...
    public AAIPv6AddressValue(IPAddress value) {
    ...
    public static AAIPv6AddressValue Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out AAIPv6AddressValue? result) {
        if (TryParseValue(text, out var value)) {
            result = new AAIPv6AddressValue(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public override bool Equals(object? obj) {
        if (obj is AAIPv6AddressValue otherValue) {
    ...
    public static implicit operator IPAddress(AAIPv6AddressValue obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(AAIPv6AddressValue obj)
        => obj.ToString();
