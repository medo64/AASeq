...
/// Binary value.
/// </summary>
public sealed class AABinaryValue : AAValue {
    ...
    public static AABinaryValue Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out AABinaryValue? result) {
        if (TryParseValue(text, out var value)) {
            result = new AABinaryValue(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator ReadOnlyMemory<Byte>(AABinaryValue obj)
       => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator Byte[](AABinaryValue obj)
       => obj.Value.ToArray();
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(AABinaryValue obj)
        => obj.ToString();
