...
/// Int64 value.
/// </summary>
public sealed class AAInt64Value : AAValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public AAInt64Value(Int64 value) {
        Value = value;
    }
    ...
    public static AAInt64Value Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out AAInt64Value? result) {
        if (TryParseValue(text, out var value)) {
            result = new AAInt64Value(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public override bool Equals(object? obj) {
        if (obj is AAInt64Value otherValue) {
    ...
    public static implicit operator long(AAInt64Value obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(AAInt64Value obj)
        => obj.ToString();
