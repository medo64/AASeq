...
/// Float32 value.
/// </summary>
public sealed class AAFloat32Value : AAValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public AAFloat32Value(Single value) {
        _value = value;
    }
    ...
    public static AAFloat32Value Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out AAFloat32Value? result) {
        if (TryParseValue(text, out var value)) {
            result = new AAFloat32Value(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public override bool Equals(object? obj) {
        if (obj is AAFloat32Value otherValue) {
    ...
    public static implicit operator float(AAFloat32Value obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(AAFloat32Value obj)
        => obj.ToString();
