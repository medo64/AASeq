...
/// DateTime value.
/// </summary>
public sealed class ValueDateTime : Value {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public ValueDateTime(DateTimeOffset value) {
        _value = value;
    }
    ...
    public static ValueDateTime Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueDateTime? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueDateTime(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator DateTimeOffset(ValueDateTime obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueDateTime obj)
        => obj.ToString();
