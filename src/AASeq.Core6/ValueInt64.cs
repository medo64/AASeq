...
/// Int64 value.
/// </summary>
public sealed class ValueInt64 : Value {
    ...
    public static ValueInt64 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueInt64? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueInt64(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator long(ValueInt64 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueInt64 obj)
        => obj.ToString();
