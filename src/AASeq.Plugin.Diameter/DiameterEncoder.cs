...
internal static class DiameterEncoder {
    ...
    private static DiameterAvp GetAvp(AvpDictionaryEntry avpEntry, AASeqValue value) {
        return avpEntry.AvpType switch {
            AvpType.Address => throw new NotImplementedException(),
            ...
            AvpType.DiameterURI => throw new NotImplementedException(),
            AvpType.Enumerated => throw new NotImplementedException(),
            AvpType.Float32 => throw new NotImplementedException(),
            AvpType.Grouped => throw new NotImplementedException(),
            ...
            AvpType.IPFilterRule => throw new NotImplementedException(),
            ...
            AvpType.QoSFilterRule => throw new NotImplementedException(),
            AvpType.Time => throw new NotImplementedException(),
