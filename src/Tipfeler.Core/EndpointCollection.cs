...
namespace Tipfeler {
    ...
    public sealed class EndpointCollection : IList<Endpoint> {
        ...
        public EndpointCollection(ICollection<Endpoint> defaultItems) {
        ...
        private readonly List<Endpoint> BaseCollection = new List<Endpoint>();
        internal readonly Dictionary<string, Endpoint> NameLookupDictionary = new Dictionary<string, Endpoint>(Endpoint.NameComparer);
        ...
        /// </summary>
        public EndpointCollection Clone() {
            var collection = new EndpointCollection();
        ...
        /// </summary>
        public EndpointCollection AsReadOnly() {
            var collection = new EndpointCollection();
            foreach (var item in this) {
        ...
        public string GetUniqueName(string baseName) {
            ...
            if (!Endpoint.NameRegex.IsMatch(baseName)) { throw new ArgumentNullException(nameof(baseName), "Base name contains some invalid characters."); }
            var index = 1;
            var name = baseName;
