    ...
    public sealed class Document {
        ...
        public static Document Load(Stream stream) {
            ...
            try {
                ...
                var rootElement = xml.SelectSingleNode("/Tipfeler");
                ...
                foreach (XmlElement endpointElement in xml.SelectNodes("Tipfeler/Endpoints/Endpoint")) {
                ...
                foreach (XmlElement interactionElement in xml.SelectNodes("Tipfeler/Interactions/*")) {
        ...
        public void Save(Stream stream) {
            ...
            try {
                using (var xw = new XmlTextWriter(stream, Document.encoding)) {
                    ...
                    xw.WriteAttributeString("xsi", "noNamespaceSchemaLocation", null, "https://api.tipfeler.com/schema/tipfeler.xsd");

                    SaveEndpoints(xw);
                    SaveFlows(xw);

                    xw.WriteEndElement(); //Tipfeler
                }
