...
namespace Tipfeler.Gui {
    ...
    internal partial class MainForm : Form {
        ...
        private void mnuOpen_Click(object sender, EventArgs e) {
            if (ProceedWithNewDocument()) {
                using (var frm = new OpenFileDialog() { Filter = "Tipfeler documents (*.tipfeler)|*.tipfeler|All files (*.*)|*.*" }) {
        ...
        private void mnuSaveAs_Click(object sender, EventArgs e) {
            using (var frm = new SaveFileDialog() { AddExtension = true, DefaultExt = "tipfeler", Filter = "Tipfeler documents (*.tipfeler)|*.tipfeler|All files (*.*)|*.*" }) {
                if (frm.ShowDialog(this) == DialogResult.OK) {
                    try {
        ...
        private void mnuAppFeedback_Click(object sender, EventArgs e) {
            Medo.Diagnostics.ErrorReport.ShowDialog(this, null, new Uri("https://api.tipfeler.com/feedback/"));
        }

        private void mnuAppUpdate_Click(object sender, EventArgs e) {
            Medo.Services.Upgrade.ShowDialog(this, new Uri("https://api.tipfeler.com/upgrade/"));
        }

        private void mnuAppAbout_Click(object sender, EventArgs e) {
            Medo.Windows.Forms.AboutBox.ShowDialog(this, new Uri("https://tipfeler.com/"));
        }
        ...
        private void RefreshTitle() {
            if (DocumentFileName != null) {
                Text = Path.GetFileNameWithoutExtension(DocumentFileName) + (Document.IsChanged ? "*" : "") + " - Tipfeler";
            } else {
                Text = "Tipfeler" + (Document.IsChanged ? "*" : "");
            }
        }
