...
/// Int16 value.
/// </summary>
public sealed class ValueInt16 : Value {
    ...
    public static ValueInt16 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueInt16? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueInt16(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator short(ValueInt16 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueInt16 obj)
        => obj.ToString();
