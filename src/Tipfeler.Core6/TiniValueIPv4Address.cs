...
/// IPv4Address value.
/// </summary>
public sealed class TiniValueIPv4Address : TiniValue {
    ...
    public TiniValueIPv4Address(IPAddress value) {
    ...
    public static TiniValueIPv4Address Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueIPv4Address? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueIPv4Address(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator IPAddress(TiniValueIPv4Address obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueIPv4Address obj)
        => obj.ToString();
