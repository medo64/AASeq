...
/// UInt16 value.
/// </summary>
public sealed class ValueUInt16 : Value {
    ...
    public static ValueUInt16 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueUInt16? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueUInt16(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator ushort(ValueUInt16 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueUInt16 obj)
        => obj.ToString();
