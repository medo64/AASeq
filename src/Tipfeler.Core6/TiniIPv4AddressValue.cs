...
/// IPv4Address value.
/// </summary>
public sealed record TiniIPv4AddressValue : TiniValue {
    ...
    public TiniIPv4AddressValue(IPAddress value) {
    ...
    public static TiniIPv4AddressValue Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniIPv4AddressValue? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniIPv4AddressValue(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator IPAddress(TiniIPv4AddressValue obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniIPv4AddressValue obj)
        => obj.ToString();
