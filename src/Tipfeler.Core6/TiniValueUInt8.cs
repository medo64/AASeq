...
/// UInt8 value.
/// </summary>
public sealed class TiniValueUInt8 : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueUInt8(Byte value) {
        _value = value;
    }
    ...
    public static TiniValueUInt8 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueUInt8? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueUInt8(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator byte(TiniValueUInt8 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueUInt8 obj)
        => obj.ToString();
