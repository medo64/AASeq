...
/// UInt64 value.
/// </summary>
public sealed class TiniValueUInt64 : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueUInt64(UInt64 value) {
        _value = value;
    }
    ...
    public static TiniValueUInt64 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueUInt64? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueUInt64(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator ulong(TiniValueUInt64 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueUInt64 obj)
        => obj.ToString();
