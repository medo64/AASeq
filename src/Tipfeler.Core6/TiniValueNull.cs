...
/// Null value.
/// </summary>
public sealed class TiniValueNull : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    public TiniValueNull() { }
...
#pragma warning disable IDE0060 // Remove unused parameter
    public static TiniValueNull Parse(string text) {
#pragma warning restore IDE0060 // Remove unused parameter
        return new TiniValueNull();
    }
...
#pragma warning disable IDE0060 // Remove unused parameter
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueNull? result) {
#pragma warning restore IDE0060 // Remove unused parameter
        result = new TiniValueNull();
        return true;
    }
    ...
    public static implicit operator string(TiniValueNull obj)
        => obj.ToString();
