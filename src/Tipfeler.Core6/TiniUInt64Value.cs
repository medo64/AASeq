...
public sealed record TiniUInt64Value : TiniValue {
    ...
    public static TiniUInt64Value Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniUInt64Value? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniUInt64Value(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator ulong(TiniUInt64Value obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniUInt64Value obj)
        => obj.ToString();
