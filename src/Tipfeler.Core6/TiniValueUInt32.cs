...
/// UInt32 value.
/// </summary>
public sealed class TiniValueUInt32 : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueUInt32(UInt32 value) {
        _value = value;
    }
    ...
    public static TiniValueUInt32 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueUInt32? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueUInt32(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator uint(TiniValueUInt32 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueUInt32 obj)
        => obj.ToString();
