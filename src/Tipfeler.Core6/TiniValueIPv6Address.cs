...
/// IPv6Address value.
/// </summary>
public sealed class TiniValueIPv6Address : TiniValue {
    ...
    public TiniValueIPv6Address(IPAddress value) {
    ...
    public static TiniValueIPv6Address Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueIPv6Address? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueIPv6Address(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator IPAddress(TiniValueIPv6Address obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueIPv6Address obj)
        => obj.ToString();
