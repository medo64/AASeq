...
public sealed record TiniUInt8Value : TiniValue {
    ...
    public static TiniUInt8Value Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniUInt8Value? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniUInt8Value(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator byte(TiniUInt8Value obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniUInt8Value obj)
        => obj.ToString();
