...
#pragma warning disable IDE0060 // Remove unused parameter
    public static ValueNull Parse(string text) {
...
#pragma warning disable IDE0060 // Remove unused parameter
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueNull? result) {
#pragma warning restore IDE0060 // Remove unused parameter
    ...
    public static implicit operator string(ValueNull obj)
        => obj.ToString();
