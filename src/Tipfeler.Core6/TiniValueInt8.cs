...
/// Int8 value.
/// </summary>
public sealed class TiniValueInt8 : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueInt8(SByte value) {
        _value = value;
    }
    ...
    public static TiniValueInt8 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueInt8? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueInt8(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator sbyte(TiniValueInt8 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueInt8 obj)
        => obj.ToString();
