...
/// Int32 value.
/// </summary>
public sealed class TiniValueInt32 : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueInt32(Int32 value) {
        _value = value;
    }
    ...
    public static TiniValueInt32 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueInt32? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueInt32(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator int(TiniValueInt32 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueInt32 obj)
        => obj.ToString();
