...
/// UInt32 value.
/// </summary>
public sealed class ValueUInt32 : Value {
    ...
    public static ValueUInt32 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueUInt32? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueUInt32(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator uint(ValueUInt32 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueUInt32 obj)
        => obj.ToString();
