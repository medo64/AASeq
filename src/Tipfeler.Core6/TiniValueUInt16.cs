...
/// UInt16 value.
/// </summary>
public sealed class TiniValueUInt16 : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueUInt16(UInt16 value) {
        _value = value;
    }
    ...
    public static TiniValueUInt16 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueUInt16? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueUInt16(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator ushort(TiniValueUInt16 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueUInt16 obj)
        => obj.ToString();
