...
/// Int16 value.
/// </summary>
public sealed class TiniValueInt16 : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueInt16(Int16 value) {
        _value = value;
    }
    ...
    public static TiniValueInt16 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueInt16? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueInt16(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator short(TiniValueInt16 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueInt16 obj)
        => obj.ToString();
