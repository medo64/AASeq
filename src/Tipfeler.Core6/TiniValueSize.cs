...
/// UInt64 value.
/// </summary>
public sealed class TiniValueSize : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueSize(UInt64 value) {
        _value = value;
    }
    ...
    public static TiniValueSize Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueSize? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueSize(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator ulong(TiniValueSize obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueSize obj)
        => obj.ToString();
