...
/// IPv4Address value.
/// </summary>
public sealed class ValueIPv4Address : Value {
    ...
    public ValueIPv4Address(IPAddress value) {
    ...
    public static ValueIPv4Address Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueIPv4Address? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueIPv4Address(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator IPAddress(ValueIPv4Address obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueIPv4Address obj)
        => obj.ToString();
