...
/// Int64 value.
/// </summary>
public sealed class TiniValueInt64 : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueInt64(Int64 value) {
        _value = value;
    }
    ...
    public static TiniValueInt64 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueInt64? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueInt64(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator long(TiniValueInt64 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueInt64 obj)
        => obj.ToString();
