...
/// Boolean value.
/// </summary>
public sealed class TiniValueBoolean : TiniValue {

    /// <summary>
    /// Creates a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueBoolean(Boolean value) {
        _value = value;
    }
    ...
    public static TiniValueBoolean Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueBoolean? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueBoolean(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator bool(TiniValueBoolean obj)
       => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueBoolean obj)
        => obj.ToString();
