...
/// IPAddress value.
/// </summary>
public sealed class TiniValueIPAddress : TiniValue {
    ...
    public TiniValueIPAddress(IPAddress value) {
    ...
    public static TiniValueIPAddress Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueIPAddress? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueIPAddress(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator IPAddress(TiniValueIPAddress obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueIPAddress obj)
        => obj.ToString();
