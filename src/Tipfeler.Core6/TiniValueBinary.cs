...
/// Binary value.
/// </summary>
public sealed class TiniValueBinary : TiniValue {
    ...
    public TiniValueBinary(ReadOnlyMemory<Byte> value) {
        _value = value;
    }
    ...
    /// <param name="value">Value.</param>
    /// <exception cref="ArgumentNullException">Value cannot be null.</exception>
    public TiniValueBinary(Byte[] value) {
    ...
    public static TiniValueBinary Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueBinary? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueBinary(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator ReadOnlyMemory<Byte>(TiniValueBinary obj)
       => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator Byte[](TiniValueBinary obj)
       => obj.Value.ToArray();
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueBinary obj)
        => obj.ToString();
