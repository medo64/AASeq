...
public sealed record TiniInt8Value : TiniValue {
    ...
    public static TiniInt8Value Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniInt8Value? result) {
    ...
    public static implicit operator sbyte(TiniInt8Value obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniInt8Value obj)
        => obj.ToString();
