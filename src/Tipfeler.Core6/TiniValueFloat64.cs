...
/// Float64 value.
/// </summary>
public sealed class TiniValueFloat64 : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueFloat64(Double value) {
        _value = value;
    }
    ...
    public static TiniValueFloat64 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueFloat64? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueFloat64(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator double(TiniValueFloat64 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueFloat64 obj)
        => obj.ToString();
