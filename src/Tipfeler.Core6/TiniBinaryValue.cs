...
public sealed record TiniBinaryValue : TiniValue {
    ...
    protected override SByte? ConvertToInt8() {
        switch (Value.Length) {
            case 1: return (SByte)Value[0];
            case 2: {
                    var value = BinaryPrimitives.ReadInt16BigEndian(Value);
                    return value is >= SByte.MinValue and <= SByte.MaxValue ? (SByte)value : null;
                }
            case 4: {
                    var value = BinaryPrimitives.ReadInt32BigEndian(Value);
                    return value is >= SByte.MinValue and <= SByte.MaxValue ? (SByte)value : null;
                }
            case 8: {
                    var value = BinaryPrimitives.ReadInt64BigEndian(Value);
                    return value is >= SByte.MinValue and <= SByte.MaxValue ? (SByte)value : null;
                }
            default: return null;
        };
    ...
    protected override Int16? ConvertToInt16() {
        switch (Value.Length) {
            case 1: return (SByte)Value[0];
            case 2: return BinaryPrimitives.ReadInt16BigEndian(Value);
            case 4: {
                    var value = BinaryPrimitives.ReadInt32BigEndian(Value);
    ...
    protected override Int32? ConvertToInt32() {
        switch (Value.Length) {
            case 1: return (SByte)Value[0];
            case 2: return BinaryPrimitives.ReadInt16BigEndian(Value);
            case 4: return BinaryPrimitives.ReadInt32BigEndian(Value);
            case 8: {
                    var value = BinaryPrimitives.ReadInt64BigEndian(Value);
    ...
    protected override Int64? ConvertToInt64() {
        return Value.Length switch {
            1 => (SByte)Value[0],
            2 => BinaryPrimitives.ReadInt16BigEndian(Value),
            4 => BinaryPrimitives.ReadInt32BigEndian(Value),
            8 => BinaryPrimitives.ReadInt64BigEndian(Value),
            _ => null,
        };
    }
    ...
    protected override Byte? ConvertToUInt8() {
        switch (Value.Length) {
            ...
            case 2: {
                    var value = BinaryPrimitives.ReadUInt16BigEndian(Value);
                    return value is <= Byte.MaxValue ? (Byte)value : null;
                }
            case 4: {
                    var value = BinaryPrimitives.ReadUInt32BigEndian(Value);
                    return value is <= Byte.MaxValue ? (Byte)value : null;
                }
            case 8: {
                    var value = BinaryPrimitives.ReadUInt64BigEndian(Value);
                    return value is <= Byte.MaxValue ? (Byte)value : null;
                }
            default: return null;
        };
    ...
    protected override UInt16? ConvertToUInt16() {
        switch (Value.Length) {
            case 1: return Value[0];
            case 2: return BinaryPrimitives.ReadUInt16BigEndian(Value);
            case 4: {
                    var value = BinaryPrimitives.ReadUInt32BigEndian(Value);
    ...
    protected override UInt32? ConvertToUInt32() {
        switch (Value.Length) {
            case 1: return Value[0];
            case 2: return BinaryPrimitives.ReadUInt16BigEndian(Value);
            case 4: return BinaryPrimitives.ReadUInt32BigEndian(Value);
            case 8: {
                    var value = BinaryPrimitives.ReadUInt64BigEndian(Value);
    ...
    protected override UInt64? ConvertToUInt64() {
        return Value.Length switch {
            1 => Value[0],
            2 => BinaryPrimitives.ReadUInt16BigEndian(Value),
            4 => BinaryPrimitives.ReadUInt32BigEndian(Value),
            8 => BinaryPrimitives.ReadUInt64BigEndian(Value),
            _ => null,
        };
    }
    ...
    protected override Single? ConvertToFloat32() {
        return Value.Length switch {
            4 => BinaryPrimitives.ReadSingleBigEndian(Value),
            8 => (float)BinaryPrimitives.ReadDoubleBigEndian(Value),
            _ => null,
        };
    }
    ...
    protected override Double? ConvertToFloat64() {
        return Value.Length switch {
            4 => BinaryPrimitives.ReadSingleBigEndian(Value),
            8 => BinaryPrimitives.ReadDoubleBigEndian(Value),
            _ => null,
        };
    }
    ...
    protected override IPAddress? ConvertToIPAddress()
        => (Value.Length is 4 or 16) ? new IPAddress(Value) : null;

    protected override IPAddress? ConvertToIPv4Address()
        => (Value.Length is 4) ? new IPAddress(Value) : null;

    protected override IPAddress? ConvertToIPv6Address()
        => (Value.Length is 16) ? new IPAddress(Value) : null;
