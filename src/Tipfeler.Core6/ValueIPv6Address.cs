...
/// IPv6Address value.
/// </summary>
public sealed class ValueIPv6Address : Value {
    ...
    public ValueIPv6Address(IPAddress value) {
    ...
    public static ValueIPv6Address Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueIPv6Address? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueIPv6Address(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator IPAddress(ValueIPv6Address obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueIPv6Address obj)
        => obj.ToString();
