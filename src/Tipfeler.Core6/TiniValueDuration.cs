...
/// Date value.
/// </summary>
public sealed class TiniValueDuration : TiniValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public TiniValueDuration(TimeSpan value) {
        _value = value;
    }
    ...
    public static TiniValueDuration Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out TiniValueDuration? result) {
        if (TryParseValue(text, out var value)) {
            result = new TiniValueDuration(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    internal static bool TryParseValue(string? text, out TimeSpan result) {
        if (TimeSpan.TryParseExact(text, TiniValueDateTime.ParseTimeSpanFormats, CultureInfo.InvariantCulture, TimeSpanStyles.None, out result)) {
            return true;
    ...
    public static implicit operator TimeSpan(TiniValueDuration obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(TiniValueDuration obj)
        => obj.ToString();
