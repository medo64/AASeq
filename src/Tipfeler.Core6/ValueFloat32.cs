...
/// Float32 value.
/// </summary>
public sealed class ValueFloat32 : Value {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public ValueFloat32(Single value) {
        _value = value;
    }
    ...
    public static ValueFloat32 Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueFloat32? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueFloat32(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator float(ValueFloat32 obj)
        => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueFloat32 obj)
        => obj.ToString();
