...
/// Binary value.
/// </summary>
public sealed class ValueBinary : Value {
    ...
    public ValueBinary(ReadOnlyMemory<Byte> value) {
        _value = value;
    }
    ...
    public static ValueBinary Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out ValueBinary? result) {
        if (TryParseValue(text, out var value)) {
            result = new ValueBinary(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public static implicit operator ReadOnlyMemory<Byte>(ValueBinary obj)
       => obj.Value;
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator Byte[](ValueBinary obj)
       => obj.Value.ToArray();
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator string(ValueBinary obj)
        => obj.ToString();
