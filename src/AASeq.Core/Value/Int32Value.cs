...
/// Int32 value.
/// </summary>
public sealed class Int32Value : AnyValue {
    ...
    public static Int32Value Parse(string text) {
    ...
    public static bool TryParse(string? text, [NotNullWhen(true)] out Int32Value? result) {
        if (TryParseValue(text, out var value)) {
            result = new Int32Value(value);
            return true;
        } else {
            result = default;
            return false;
    ...
    public override bool Equals(object? obj) {
        if (obj is Int32Value otherValue) {
    ...
    /// <summary>
    /// Convert object into an Int32.
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static Int32 ToInt32(Int32Value obj) {
        Helpers.ThrowIfArgumentNull(obj, nameof(obj), "Parameter cannot be null.");
        return obj.Value;
    }

    /// <summary>
    /// Implicit conversion into an Int32.
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator Int32(Int32Value obj)
        => ToInt32(obj);
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static String ToString(Int32Value obj) {
        Helpers.ThrowIfArgumentNull(obj, nameof(obj), "Parameter cannot be null.");
        return obj.ToString();
    }
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator String(Int32Value obj)
        => ToString(obj);
