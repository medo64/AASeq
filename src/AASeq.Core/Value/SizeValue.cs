...
/// UInt64 value.
/// </summary>
public sealed class SizeValue : AnyValue {

    /// <summary>
    /// Create a new instance.
    /// </summary>
    /// <param name="value">Value.</param>
    public SizeValue(UInt64 value) {
        Value = value;
    }
    ...
    public static SizeValue Parse(string text) {
    ...
    public override bool Equals(object? obj) {
        if (obj is SizeValue otherValue) {
    ...
    public static UInt64 ToUInt64(SizeValue obj) {
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator UInt64(SizeValue obj)
        => ToUInt64( obj);
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static String ToString(SizeValue obj) {
        Helpers.ThrowIfArgumentNull(obj, nameof(obj), "Parameter cannot be null.");
        return obj.ToString();
    }
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator String(SizeValue obj)
        => ToString(obj);
