...
/// UInt8 value.
/// </summary>
public sealed class UInt8Value : AnyValue {
    ...
    public static UInt8Value Parse(string text) {
    ...
    public override bool Equals(object? obj) {
        if (obj is UInt8Value otherValue) {
    ...
    /// <summary>
    /// Convert object into a Byte.
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static Byte ToByte(UInt8Value obj) {
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator Byte(UInt8Value obj)
        => ToByte(obj);
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static string ToString(UInt8Value obj) {
        Helpers.ThrowIfArgumentNull(obj, nameof(obj), "Parameter cannot be null.");
        return obj.ToString();
    }
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator String(UInt8Value obj)
        => ToString(obj);
