...
/// IPv6Address value.
/// </summary>
public sealed class IPv6AddressValue : AnyValue {
    ...
    public IPv6AddressValue(IPAddress value) {
    ...
    public static IPv6AddressValue Parse(string text) {
    ...
    public override bool Equals(object? obj) {
        if (obj is IPv6AddressValue otherValue) {
    ...
    public static IPAddress ToIPAddress(IPv6AddressValue obj) {
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator IPAddress(IPv6AddressValue obj)
        => ToIPAddress(obj);
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static String ToString(IPv6AddressValue obj) {
        Helpers.ThrowIfArgumentNull(obj, nameof(obj), "Parameter cannot be null.");
        return obj.ToString();
    }
    ...
    /// </summary>
    /// <param name="obj">Value object.</param>
    public static implicit operator String(IPv6AddressValue obj)
        => ToString(obj);
