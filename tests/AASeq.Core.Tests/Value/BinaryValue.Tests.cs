...
[TestClass]
public class BinaryValue_Tests {

    [TestMethod]
    public void BinaryValue_Basic() {
        var text = "0xFEFF";
    ...
    [TestMethod]
    public void BinaryValue_NoPrefix() {
        var text = "fefe";
        Assert.IsTrue(BinaryValue.TryParse(text, out var result));
    ...
    [TestMethod]
    public void BinaryValue_AsInt16() {
        var binary1P = new BinaryValue(new byte[] { 0x00, 0x30 });
        Assert.AreEqual((sbyte)48, binary1P.AsSByte());
        Assert.AreEqual((short)48, binary1P.AsInt16());
        Assert.AreEqual(48, binary1P.AsInt32());
        Assert.AreEqual(48L, binary1P.AsInt64());
        ...
        var binary1N = new BinaryValue(new byte[] { 0x00, 0x82 });
        Assert.IsNull(binary1N.AsSByte());
        ...
        var binary2N = new BinaryValue(new byte[] { 0x81, 0x30 });
        Assert.IsNull(binary2N.AsSByte());
    ...
    public void BinaryValue_AsInt32() {
        ...
        var binary2P = new BinaryValue(new byte[] { 0x00, 0x00, 0x04, 0x12 });
        Assert.IsNull(binary2P.AsSByte());
        ...
        var binary2N = new BinaryValue(new byte[] { 0x00, 0x00, 0x94, 0x12 });  // not really a negative number
        Assert.IsNull(binary2N.AsSByte());
    ...
    [TestMethod]
    public void BinaryValue_AsInt64() {
        var binary1P = new BinaryValue(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2A });
        Assert.AreEqual((sbyte)42, binary1P.AsSByte());
        Assert.AreEqual((short)42, binary1P.AsInt16());
        Assert.AreEqual(42, binary1P.AsInt32());
        Assert.AreEqual(42L, binary1P.AsInt64());
        ...
        var binary1N = new BinaryValue(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA });
        Assert.IsNull(binary1N.AsSByte());
        Assert.AreEqual((short)170, binary1N.AsInt16());
        Assert.AreEqual(170, binary1N.AsInt32());
        Assert.AreEqual(170L, binary1N.AsInt64());
        Assert.AreEqual((byte)170, binary1N.AsByte());
        ...
        var binary2P = new BinaryValue(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x12 });
        Assert.IsNull(binary2P.AsSByte());
        Assert.AreEqual((short)1042, binary2P.AsInt16());
        Assert.AreEqual(1042, binary2P.AsInt32());
        Assert.AreEqual(1042L, binary2P.AsInt64());
        ...
        var binary2N = new BinaryValue(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xD4, 0x12 });
        Assert.IsNull(binary2N.AsSByte());
        Assert.IsNull(binary2N.AsInt16());
        ...
        var binary4P = new BinaryValue(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x86, 0xCA });
        Assert.IsNull(binary4P.AsSByte());
        Assert.IsNull(binary4P.AsInt16());
        Assert.AreEqual(100042, binary4P.AsInt32());
        Assert.AreEqual(100042L, binary4P.AsInt64());
        ...
        var binary4N = new BinaryValue(new byte[] { 0x00, 0x00, 0x00, 0x00, 0xF0, 0x01, 0x86, 0xCA });
        Assert.IsNull(binary4N.AsSByte());
        Assert.IsNull(binary4N.AsInt16());
    ...
    [TestMethod]
    public void BinaryValue_ReadOnlyMemory() {
        var buffer = new byte[] { 0x01, 0x02 };
        var x = new BinaryValue(buffer);
        buffer[1] = 0x2A;
