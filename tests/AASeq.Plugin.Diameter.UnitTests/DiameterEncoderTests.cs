...
public class DiameterEncoderTests {
    ...
    public void DiameterEncoder_EncodeCER() {
        ...
        Assert.IsNull(message.Avps[0].VendorId);
        ...
        Assert.IsNull(message.Avps[1].VendorId);
        ...
        Assert.IsNull(message.Avps[2].VendorId);
        ...
        Assert.IsNull(message.Avps[3].VendorId);
        ...
        Assert.IsNull(message.Avps[4].VendorId);
        ...
        Assert.IsNull(message.Avps[5].VendorId);
