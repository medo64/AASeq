...
namespace Clamito {
    internal static class Log {
        ...
        public static void RecordDocumentLoad(long elapsedMilliseconds) {
            Source.TraceEvent(TraceEventType.Information, 0, "Document.Load in {0} ms.", elapsedMilliseconds);
        }

        [Conditional("TRACE")]
        public static void RecordDocumentSave(long elapsedMilliseconds) {
            Source.TraceEvent(TraceEventType.Information, 0, "Document.Save in {0} ms.", elapsedMilliseconds);
        }
