...
namespace Clamito.Test {
    ...
    public class MessageTests {
        ...
        public void Message_Clone() {
            ...
            s.Fields.Add(new Field("H1", "V1"));
            s.Fields.Add(new Field("H2"));
            s.Fields.Add(new Field("F1", "V1"));
            s.Fields.Add(new Field("F2"));
            ...
            Assert.AreEqual(4, ((Message)x).Fields.Count);
            Assert.AreEqual("H1", ((Message)x).Fields[0].Name);
            Assert.AreEqual("V1", ((Message)x).Fields[0].Value);
            Assert.AreEqual("H2", ((Message)x).Fields[1].Name);
            Assert.AreEqual(false, ((Message)x).Fields[1].HasValue);
            Assert.AreEqual(true, ((Message)x).Fields[1].HasSubfields);
            Assert.AreEqual("F1", ((Message)x).Fields[2].Name);
            Assert.AreEqual("V1", ((Message)x).Fields[2].Value);
            Assert.AreEqual("F2", ((Message)x).Fields[3].Name);
            Assert.AreEqual(false, ((Message)x).Fields[3].HasValue);
            Assert.AreEqual(true, ((Message)x).Fields[3].HasSubfields);
        }
        ...
        public void Message_ToMultilineContent_Simple() {
            ...
            message.Fields.Add(new Field(".H1", "V1"));
            message.Fields.Add(new Field("F1", "V1"));
            message.Fields.Add(new Field("F2", "V2"));

            Assert.AreEqual(GetFragment("Simple.output"), message.Fields.ToString());
        }
