...
namespace Tipfeler.Test {
    ...
    public class DocumentTests {
        ...
        public void Document_LoadAndSave_Empty() {
            var input = GetDocumentStream("Empty.tipfeler");
        ...
        public void Document_LoadAndSave_Basic() {
            var input = GetDocumentStream("Basic.tipfeler");
            var output = new MemoryStream();
        ...
        public void Document_LoadAndSave_InvalidVersion() {
            var input = GetDocumentStream("InvalidVersion.tipfeler");
            var doc = Document.Load(input);
        }
        ...
        private static MemoryStream GetDocumentStream(string fileName) {
            var resStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Tipfeler.Test.Core.Resources.Documents." + fileName);
