...
public class TiniValueBinaryTests {

    [Fact(DisplayName = "TiniValueBinary: Basic")]
    public void Basic() {
        var text = "0xFEFE";
        Assert.True(TiniValueBinary.TryParse(text, out var result));
        Assert.Equal("FE-FE", BitConverter.ToString(result));
        Assert.Equal("0xFEFE", TiniValueBinary.Parse(text));
    }

    [Fact(DisplayName = "TiniValueBinary: No prefix")]
    ...
    [Fact(DisplayName = "TiniValueBinary: Int8")]
    public void Int8() {
        var binary1P = new TiniValueBinary(new byte[] { 0x30 });
        ...
        var binary1N = new TiniValueBinary(new byte[] { 0x82 });
    ...
    [Fact(DisplayName = "TiniValueBinary: Int16")]
    public void Int16() {
        var binary1P = new TiniValueBinary(new byte[] { 0x00, 0x30 });
        Assert.Equal((sbyte)48, binary1P.AsInt8());
        Assert.Equal((short)48, binary1P.AsInt16());
        Assert.Equal(48, binary1P.AsInt32());
        Assert.Equal(48L, binary1P.AsInt64());
        ...
        var binary1N = new TiniValueBinary(new byte[] { 0x00, 0x82 });
        ...
        var binary2P = new TiniValueBinary(new byte[] { 0x01, 0x30 });
        ...
        var binary2N = new TiniValueBinary(new byte[] { 0x81, 0x30 });
    ...
    [Fact(DisplayName = "TiniValueBinary: Int32")]
    public void Int32() {
        var binary1P = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x00, 0x2A });
        ...
        var binary1N = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x00, 0x9A });  // not real negative
        Assert.Null(binary1N.AsInt8());
        ...
        var binary2P = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x04, 0x12 });
        Assert.Null(binary2P.AsInt8());
        ...
        var binary2N = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x94, 0x12 });  // not really a negative number
        Assert.Null(binary2N.AsInt8());
        ...
        var binary4P = new TiniValueBinary(new byte[] { 0x00, 0x01, 0x86, 0xCA });
        ...
        var binary4N = new TiniValueBinary(new byte[] { 0x80, 0x01, 0x86, 0xCA });
    ...
    [Fact(DisplayName = "TiniValueBinary: Int64")]
    public void Int64() {
        var binary1P = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x2A });
        Assert.Equal((sbyte)42, binary1P.AsInt8());
        Assert.Equal((short)42, binary1P.AsInt16());
        Assert.Equal(42, binary1P.AsInt32());
        Assert.Equal(42L, binary1P.AsInt64());
        ...
        var binary1N = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA });
        Assert.Null(binary1N.AsInt8());
        ...
        var binary2P = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x04, 0x12 });
        Assert.Null(binary2P.AsInt8());
        Assert.Equal((short)1042, binary2P.AsInt16());
        Assert.Equal(1042, binary2P.AsInt32());
        Assert.Equal(1042L, binary2P.AsInt64());
        ...
        var binary2N = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xD4, 0x12 });
        Assert.Null(binary2N.AsInt8());
        Assert.Null(binary2N.AsInt16());
        ...
        var binary4P = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x86, 0xCA });
        Assert.Null(binary4P.AsInt8());
        Assert.Null(binary4P.AsInt16());
        Assert.Equal(100042, binary4P.AsInt32());
        Assert.Equal(100042L, binary4P.AsInt64());
        ...
        var binary4N = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x00, 0x00, 0xF0, 0x01, 0x86, 0xCA });
        Assert.Null(binary4N.AsInt8());
        Assert.Null(binary4N.AsInt16());
        ...
        var binary8P = new TiniValueBinary(new byte[] { 0x00, 0x00, 0x00, 0x17, 0x48, 0x76, 0xE8, 0x2A });
        ...
        var binary8N = new TiniValueBinary(new byte[] { 0xB0, 0x00, 0x00, 0x17, 0x48, 0x76, 0xE8, 0x2A });
    ...
    [Fact(DisplayName = "TiniValueBinary: Failed Parse")]
    public void FailedParse() {
        Assert.False(TiniValueBoolean.TryParse("GG", out var _));
        Assert.Throws<FormatException>(() => {
            TiniValueBoolean.Parse("GG");
        });
    ...
    [Fact(DisplayName = "TiniValueBinary: ReadOnlyMemory")]
    public void ReadOnlyMemory() {
        var buffer = new byte[] { 0x01, 0x02 };
        var x = new TiniValueBinary(buffer);
        buffer[1] = 0x2A;
